...
/**
 * Protobuf message : pulsar.proto.CommandEndTxnOnSubscription
 */
class CommandEndTxnOnSubscription extends \Protobuf\AbstractMessage
{
    ...
    /**
     * subscription optional message = 4
     *
     * @var \Pulsar\Proto\Subscription
     */
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'  => 'CommandEndTxnOnSubscription',
            'field' => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandEndTxnOnSubscription#request_id" (tag 1) is required but has no value.');
        }
        ...
        if ($this->subscription !== null) {
            ...
            $writer->writeVarint($stream, $this->subscription->serializedSize($sizeContext));
            $this->subscription->writeTo($context);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $this->subscription = $innerMessage;
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->subscription !== null) {
            $innerSize = $this->subscription->serializedSize($context);
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandEndTxnOnSubscription) {
