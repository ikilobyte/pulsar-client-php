...
/**
 * Protobuf message : pulsar.proto.CommandNewTxnResponse
 */
class CommandNewTxnResponse extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandNewTxnResponse#request_id" (tag 1) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandNewTxnResponse) {
