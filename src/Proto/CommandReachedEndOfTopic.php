...
/**
 * Protobuf message : pulsar.proto.CommandReachedEndOfTopic
 */
class CommandReachedEndOfTopic extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->consumer_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandReachedEndOfTopic#consumer_id" (tag 1) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandReachedEndOfTopic) {
