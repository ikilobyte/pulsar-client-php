...
/**
 * Protobuf message : pulsar.proto.CommandCloseProducer
 */
class CommandCloseProducer extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->producer_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandCloseProducer#producer_id" (tag 1) is required but has no value.');
        }

        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandCloseProducer#request_id" (tag 2) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandCloseProducer) {
