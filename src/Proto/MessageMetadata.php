...
class MessageMetadata extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        ...
        self::UNCOMPRESSED_SIZE => array(
            'default' => 0,
            'name' => 'uncompressed_size',
            'required' => false,
            'type' => \ProtobufMessage::PB_TYPE_INT,
        ),
        self::NUM_MESSAGES_IN_BATCH => array(
            'default' => 1,
        ...
        self::ENCRYPTION_KEYS => array(
            'name' => 'encryption_keys',
            'repeated' => true,
            'type' => '\Pulsar\Proto\EncryptionKeys'
        ),
        self::ENCRYPTION_ALGO => array(
            'name' => 'encryption_algo',
            'required' => false,
            'type' => \ProtobufMessage::PB_TYPE_STRING,
        ),
        self::ENCRYPTION_PARAM => array(
        ...
        self::DELIVER_AT_TIME => array(
            'name' => 'deliver_at_time',
            'required' => false,
            'type' => \ProtobufMessage::PB_TYPE_INT,
        ),
        self::MARKER_TYPE => array(
            'name' => 'marker_type',
            'required' => false,
            'type' => \ProtobufMessage::PB_TYPE_INT,
        ),
        ...
        self::NUM_CHUNKS_FROM_MSG => array(
            'name' => 'num_chunks_from_msg',
            'required' => false,
            'type' => \ProtobufMessage::PB_TYPE_INT,
        ),
        self::TOTAL_CHUNK_MSG_SIZE => array(
    ...
    public function reset()
    {
        ...
        $this->values[self::REPLICATE_TO] = array();
        ...
        $this->values[self::ENCRYPTION_KEYS] = array();
