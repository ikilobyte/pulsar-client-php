...
/**
 * Protobuf message : pulsar.proto.CommandError
 */
class CommandError extends \Protobuf\AbstractMessage
{
    ...
    public static function fromArray(array $values)
    {
        ...
        if (!isset($values['error'])) {
            throw new \InvalidArgumentException('Field "error" (tag 2) is required but has no value.');
        }

        if (!isset($values['message'])) {
            throw new \InvalidArgumentException('Field "message" (tag 3) is required but has no value.');
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandError#request_id" (tag 1) is required but has no value.');
        }

        if ($this->error === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandError#error" (tag 2) is required but has no value.');
        }

        if ($this->message === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandError#message" (tag 3) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandError) {
