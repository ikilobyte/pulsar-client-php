...
/**
 * Protobuf message : pulsar.proto.CommandAddPartitionToTxn
 */
class CommandAddPartitionToTxn extends \Protobuf\AbstractMessage
{
     ...
     * @return bool
     */
    public function hasPartitionsList()
    {
     ...
     * @param string $value
     */
    public function addPartitions($value)
    {
        if ($this->partitions === null) {
            $this->partitions = new \Protobuf\ScalarCollection();
        }
    ...
    public static function fromArray(array $values)
    {
        ...
        foreach ($values['partitions'] as $item) {
            $message->addPartitions($item);
        }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandAddPartitionToTxn#request_id" (tag 1) is required but has no value.');
        }
        ...
        if ($this->partitions !== null) {
            foreach ($this->partitions as $val) {
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $this->partitions->add($reader->readString($stream));
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandAddPartitionToTxn) {
