...
/**
 * Protobuf message : pulsar.proto.CommandAddSubscriptionToTxnResponse
 */
class CommandAddSubscriptionToTxnResponse extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'  => 'CommandAddSubscriptionToTxnResponse',
            'field' => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandAddSubscriptionToTxnResponse#request_id" (tag 1) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandAddSubscriptionToTxnResponse) {
