...
/**
 * Protobuf message : pulsar.proto.CommandGetLastMessageId
 */
class CommandGetLastMessageId extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->consumer_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandGetLastMessageId#consumer_id" (tag 1) is required but has no value.');
        }

        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandGetLastMessageId#request_id" (tag 2) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandGetLastMessageId) {
