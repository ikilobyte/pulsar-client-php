...
/**
 * Protobuf message : pulsar.proto.CommandUnsubscribe
 */
class CommandUnsubscribe extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->consumer_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandUnsubscribe#consumer_id" (tag 1) is required but has no value.');
        }

        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandUnsubscribe#request_id" (tag 2) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandUnsubscribe) {
