...
/**
 * Protobuf message : pulsar.proto.CommandAddSubscriptionToTxn
 */
class CommandAddSubscriptionToTxn extends \Protobuf\AbstractMessage
{
    ...
    /**
     * subscription repeated message = 4
     *
     * @var \Protobuf\Collection<\Pulsar\Proto\Subscription>
     */
     ...
     * @return bool
     */
    public function hasSubscriptionList()
    {
     ...
     *
     * @return \Protobuf\Collection<\Pulsar\Proto\Subscription>
     */
     ...
     *
     * @param \Protobuf\Collection<\Pulsar\Proto\Subscription> $value
     */
    public function setSubscriptionList(?\Protobuf\Collection $value = null)
    {
        $this->subscription = $value;
    }

    /**
     * Add a new element to 'subscription'
     *
     * @param \Pulsar\Proto\Subscription $value
     */
    public function addSubscription(\Pulsar\Proto\Subscription $value)
    {
        if ($this->subscription === null) {
            $this->subscription = new \Protobuf\MessageCollection();
        }
    ...
    public static function fromArray(array $values)
    {
        ...
        foreach ($values['subscription'] as $item) {
            $message->addSubscription($item);
        }
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'  => 'CommandAddSubscriptionToTxn',
            'field' => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.pulsar.proto.Subscription',
                ]),
            ],
        ]);
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandAddSubscriptionToTxn#request_id" (tag 1) is required but has no value.');
        }
        ...
        if ($this->subscription !== null) {
            foreach ($this->subscription as $val) {
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $innerMessage = new \Pulsar\Proto\Subscription();

                if ($this->subscription === null) {
                    $this->subscription = new \Protobuf\MessageCollection();
                }

                $this->subscription->add($innerMessage);
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandAddSubscriptionToTxn) {
