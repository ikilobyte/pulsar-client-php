...
/**
 * Protobuf message : pulsar.proto.CommandEndTxnOnPartitionResponse
 */
class CommandEndTxnOnPartitionResponse extends \Protobuf\AbstractMessage
{
    ...
    public static function descriptor()
    {
        return \google\protobuf\DescriptorProto::fromArray([
            'name'  => 'CommandEndTxnOnPartitionResponse',
            'field' => [
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandEndTxnOnPartitionResponse#request_id" (tag 1) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandEndTxnOnPartitionResponse) {
