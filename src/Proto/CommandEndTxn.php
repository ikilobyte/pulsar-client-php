...
/**
 * Protobuf message : pulsar.proto.CommandEndTxn
 */
class CommandEndTxn extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->request_id === null) {
            throw new \UnexpectedValueException('Field "\\pulsar\\proto\\CommandEndTxn#request_id" (tag 1) is required but has no value.');
        }
    ...
    {
        if (!$message instanceof \Pulsar\Proto\CommandEndTxn) {
